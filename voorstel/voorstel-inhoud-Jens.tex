...
Daarbij streven we naar de volgende doelstellingen en meetbare deelvragen:
\begin{itemize}
    \item Het ontwikkelen/verbeteren van een model dat de kwaliteit van speech-to-text voor de Nederlandse taal kan verbeteren.
        \SubItem{Wat is de invloed van omgevingsgeluid op de kwaliteit van speech-to-text? (gemeten aan de hand van word error rate)}
        \SubItem{Hoe goed werken modellen die getraind zijn op andere talen?}
    \item Het model moet een goede word error rate hebben voor woorden die niet behoren tot de standaardtaal.
        \SubItem{Hoe presteert het ontwikkelde/verbeterde model op woorden die niet behoren tot de standaardtaal?}
    \item Identificeren van goede en slechte open en closed-source modellen voor Nederlands.
        \SubItem{Welke open en closed-source modellen presteren het beste voor Nederlands?}
\end{itemize}
